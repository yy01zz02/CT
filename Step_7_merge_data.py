...
file1_path = "data/PromSec/bandit/bandit_PromSec.json"
file2_path = "data/PromSec/reasoning/fixed_and_reason_all.json"
output_path = "data/PromSec/PromSec_data.json"
