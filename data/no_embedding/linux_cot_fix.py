...
from experimental_methods import cot_fix, remove_backticks
import os
...
for model_path in model_list:
    ...
    for name in data_names:
        ...
        prompt_file = f'../exp/{model_name}/{name}/{f_name}_{vers}.json'
        # 读取已经处理过的数据
        ...
        for item in data:
            ...
            s_cot_0 = meta_data_0['s_cot']

            prompt = cot_fix(bug, s_cot_0, exp_bug_0, fixed_code_0)
            ...
            while True:
                ...
                generated_ids = model.generate(encoding.input_ids, max_new_tokens=256, do_sample=True, temperature=0.7)
            ...
            # 保存结果路径
            json_path = f'{folder_path}{f_name}_{vers}.json'
