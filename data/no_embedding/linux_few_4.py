...
from experimental_methods import few_4, remove_backticks
import os
...
for model_path in model_list:
    ...
    for name in data_names:
        ...
        for item in data:
            ...
            prompt = few_4(bug, exp_bug_0, fixed_code_0, exp_bug_1, fixed_code_1, exp_bug_2, fixed_code_2, exp_bug_3,
                           fixed_code_3)
