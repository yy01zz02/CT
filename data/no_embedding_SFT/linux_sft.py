...
import json
from experimental_methods import zeroshot, remove_backticks
...
model_path = "/home/zdx_zp/model/Qwen/Qwen2.5-Coder-7B-Instruct"
...
for name in data_names:
    ...
    for item in data:
        ...
        while True:
            ...
            result = client.chat.completions.create(messages=messages, model=model_path)
