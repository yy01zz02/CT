...
def cot_prompt(block: str, example_cot: str, example_bug: str, example_fix: str) -> str:
...
def oneshot_prompt(block: str, example_bug: str, example_fix: str, example_bug_1: str, example_fix_1: str, example_bug_2: str, example_fix_2: str) -> str:
...
def oneshot_prompt_4(block: str, example_bug: str, example_fix: str, example_bug_1: str, example_fix_1: str,
...
def oneshot_prompt_5(block: str, example_bug: str, example_fix: str, example_bug_1: str, example_fix_1: str,
