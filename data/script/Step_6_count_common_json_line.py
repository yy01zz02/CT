...
json_file1 = "data/SecCodePLT/fixed_and_reason_all.json"
json_file2 = "data/SecCodePLT/fixed_and_reason.json"
common_count = count_common_entries(json_file1, json_file2)
print(f"Number of common entries: {common_count}")

json_file1 = "data/SecCodePLT/fixed_and_reason_all.json"
json_file2 = "data/SecCodePLT/fixed_and_reason_1.json"
common_count = count_common_entries(json_file1, json_file2)
print(f"Number of common entries: {common_count}")

json_file1 = "data/SecCodePLT/fixed_and_reason_all.json"
json_file2 = "data/SecCodePLT/fixed_and_reason_2.json"
common_count = count_common_entries(json_file1, json_file2)
print(f"Number of common entries: {common_count}")

json_file1 = "data/SecCodePLT/fixed_and_reason_all.json"
json_file2 = "data/SecCodePLT/fixed_and_reason_3.json"
common_count = count_common_entries(json_file1, json_file2)
print(f"Number of common entries: {common_count}")

json_file1 = "data/SecCodePLT/fixed_and_reason_all.json"
json_file2 = "data/SecCodePLT/fixed_and_reason_4.json"
common_count = count_common_entries(json_file1, json_file2)
print(f"Number of common entries: {common_count}")
...
# data/SecCodePLT/fixed_and_reason.json: 280
# data/SecCodePLT/fixed_and_reason_1.json: 114
# data/SecCodePLT/fixed_and_reason_2.json: 33
# data/SecCodePLT/fixed_and_reason_3.json: 10
# data/SecCodePLT/fixed_and_reason_4.json: 2
# data/SecCodePLT/fixed_and_reason_all.json: 280
