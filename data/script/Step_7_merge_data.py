...
file1_path = "../SecCodePLT/bandit/bandit_SecCodePLT.json"
file2_path = "../SecCodePLT/reasoning/fixed_and_reason_all.json"
output_path = "../SecCodePLT/SecCodePLT_data.json"
