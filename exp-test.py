...
from experimental_methods import format_bandit, normal_fix, cot_prompt, remove_backticks
...
for model_name in model_list:
    ...
    for name in data_name:
        ...
        for item in data:
            ...
            prompts = {"prompt_not_cot": normal_fix(code, bandit_result),
            ...
            for prompt_name, prompt in prompts.items():
                ...
                json_path = f'{folder_path}{prompt_name}.json'

                with open(json_path, 'a', encoding='utf-8') as file_j:
                    json.dump({"id": ID, "fixed_list": fixed_json, "flag": str(flag)}, file_j)
