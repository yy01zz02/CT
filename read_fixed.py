...
file_path = 'data/SecurityEval/deepseek/deepseek_SecurityEval_fixed_3.json'
save_path = 'data/SecurityEval/reasoning/fixed_and_reason_3.json'
...
print("Data has been written to 'fixed_and_reason.json'")
