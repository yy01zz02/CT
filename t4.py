...
with open("data/SecurityEval/SecurityEval_final.json", 'r', encoding='utf-8') as f:
    data = json.load(f)

# 提取每条数据中的 "buggy_code" 和 "s_cot"
filtered_data = [{"buggy_code": item.get("buggy_code"), "s_cot": item.get("s_cot")} for item in data]
